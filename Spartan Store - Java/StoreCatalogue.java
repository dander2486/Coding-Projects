...
/** This class represents the store catalogue which will store all of the
...
public class StoreCatalogue implements Catalogue, Serializable {
  ...
  private static final long  serialVersionUID = 99990009L;
  ...
  /**This constructor takes an ASCIIDataFile and reads the information given for each
    * item in the order of ItemNumber, ItemPrice, ItemDescription, and adds them to
    * the catalogue. */
