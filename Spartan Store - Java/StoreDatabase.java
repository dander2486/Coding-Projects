...
public class StoreDatabase implements Database, Serializable{
  ...
  private static final long  serialVersionUID = 99990011L;
  ...
  /** This constructor takes an ASCIIDataFile and assumes the first half contains the items for the
    * store's catalogue. Once the catalogue's intialized, a list of Store Customers is initialized and
    * provided with each customer's information along with a base Cart containing the store's catalogue
    * for each customer. */
